...
from robo_bot_cli.initial_structure.resources_path import (
    initial_project_path,
    language_project_path,
)
from robo_bot_cli.util.cli import print_info, print_success
from robo_bot_cli.util.helpers import get_index
from robo_bot_cli.util.input_output import (
    load_yaml,
    save_yaml,
    write_requirements,
)
...
def language_detection_setup(path: str) -> None:
    ...
    for folder in folder_list:
        ...
        responses_dict["utter_bot_languages"] = [
            {"text": "Do you want to speak with me in another language?"}
        ]
